...
class CustomCLIP_VPTD(nn.Module):
    ...
    def forward(self, image):
        ...
        with torch.no_grad():
            zeroshotclip_image_feature, zero_shot_clip_weights = self.zeroshot_clip_image_encoder(image.type(self.dtype))
        ...
        return logits, logits1, logits2, weights
...
class VLP(TrainerX):
    ...
    def forward_backward(self, batch):
        ...
        if prec == "amp":
            ...
            output, output1, output2, weights = self.model(image)
