...
python train.py --root ./datasets/${DATADIR} --seed $j \
--trainer $MODEL \
--dataset-config-file configs/datasets/${DATASET}.yaml \
--output-dir ./outputs/output_$DATASET\_$MODEL \
--gen-heatmap \
--heatmap-impath brain/images/meningioma/Te-me_0157.jpg \
